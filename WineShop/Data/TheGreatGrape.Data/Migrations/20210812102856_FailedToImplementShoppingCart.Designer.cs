...
namespace TheGreatGrape.Data.Migrations
{
    ...
    [Migration("20210812102856_FailedToImplementShoppingCart")]
    partial class FailedToImplementShoppingCart
    {
            ...
            modelBuilder.Entity("TheGreatGrape.Data.Models.ApplicationUser", b =>
                {
                    b.HasOne("TheGreatGrape.Data.Models.TheGreatGrape.Models.ShoppingCart", "ShoppingCart")
                        .WithOne("User")
                        .HasForeignKey("TheGreatGrape.Data.Models.ApplicationUser", "ShoppingCartId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
